...
class MNIST_MLP(object):
    def __init__(self, batch_size=100, input_size=784, hidden1=784, hidden2=128, out_classes=10, lr=0.01, max_epoch=1, print_iter=100):
    ...
    def load_data(self):
        ...
        #注意 load_minst(self, file_dir, is_images)中is_image的取值
    ...
    def build_model(self):  # 建立网络结构
        ...
        # 定义ReLU激活函数层1，用于对全连接层1的输出进行非线性变换
    ...
    def forward(self, input):  # 神经网络的前向传播
        ...
        # 将 h1 经过ReLU激活函数层进行非线性变换，得到激活后的输出
        h1 = self.relu1.forward(h1)
        h2=self.fc2.forward(h1)
        h2=self.relu2.forward(h2)
        h3=self.fc3.forward(h2)
        # 将 h3 经过Softmax和交叉熵损失函数层进行处理
