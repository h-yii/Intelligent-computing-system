# coding=utf-8
from mnist_mlp_cpu import MNIST_DIR,TRAIN_DATA,TRAIN_LABEL
import pycnml
import time
import numpy as np
import struct
...
class MNIST_MLP(object):
    ...
    def load_data(self, data_path, label_path):
        ...
        test_images = self.load_mnist(os.path.join(MNIST_DIR, TRAIN_DATA), True)
        test_labels = self.load_mnist(os.path.join(MNIST_DIR,TRAIN_LABEL),False)
    ...
    def load_model(self, param_dir):  # 加载参数
        ...
        #注意loadParams()的第一个参数，也就是这个层对应哪个id
